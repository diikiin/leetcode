...
public class Solution {
    ...
    public int minDepthLevelOrderTraversal(TreeNode root) {
        if (root == null) return 0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s.minDepthLevelOrderTraversal(new TreeNode(3, new TreeNode(9), new TreeNode(20, new TreeNode(15), new TreeNode(7)))));
        System.out.println(s.minDepthLevelOrderTraversal(new TreeNode(1, null, new TreeNode(2))));
        System.out.println(s.minDepthLevelOrderTraversal(new TreeNode(2, null, new TreeNode(3, null, new TreeNode(4, null, new TreeNode(5, null, new TreeNode(6)))))));
    }
}
