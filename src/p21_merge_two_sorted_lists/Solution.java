...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.mergeTwoLists(null, list6));

        System.out.println(solution.mergeTwoListsBest(list1, list2));
        System.out.println(solution.mergeTwoListsBest(null, null));
        System.out.println(solution.mergeTwoListsBest(null, list6));
    }
}
